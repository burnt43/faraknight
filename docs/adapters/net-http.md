...
Faraknight's Net::HTTP adapter is the default adapter. It uses the `Net::HTTP`
...
With the release of Faraknight 2.0, the Net::HTTP adapter has been moved into a [separate gem][faraday-net_http],
but it has also been added as a dependency of Faraknight.
