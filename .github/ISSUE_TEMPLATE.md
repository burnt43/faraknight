...
* Are you using the latest Faraknight version? If not, please check the [Releases](https://github.com/lostisland/faraday/releases) page to see if the issue has already been fixed.
* Provide the Faraknight and Ruby Version you're using while experiencing the issue.
